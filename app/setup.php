<?php
	...
	// APP URL
	define('APP_URL', 'http://localhost/respond');
	...
	// Brand name
	define('BRAND', 'Galactic Mango CMS');
	...
	define('COPY', 'By Anstroy95');
	define('EMAIL', 'austrebertog@gmail.com');
	...
	define('SYSTEM_MESSAGE', 'GalacticMango CMS');
	...
	// Default bucket
	define('BUCKET_NAME', 'GalacticMango');
	...
	// Paypal
	define('PAYPAL_EMAIL', 'austrebertog@gmail.com');
	...
	define('SMTP_USERNAME', 'austrebertog@gmail.com');
	define('SMTP_PASSWORD', '3100203123456789');
	...
	define('WELCOME_EMAIL_SUBJECT', 'GalacticMango: Welcome to the Family!');
	define('WELCOME_EMAIL_FILE', '../emails/new-user.html');

	// New subscription email (to user)
	define('NEW_SUBSCRIPTION_EMAIL', true);
	define('NEW_SUBSCRIPTION_EMAIL_SUBJECT', 'GalacticMango: Thank you for subscribing!');
	...
	define('NEW_SUBSCRIBER_EMAIL_SUBJECT', 'GalacticMango: We have a new subscriber!');
